 ...
 *
 */
public class AllInOne2 extends AllInOneBase2{
	
	private final static Logger log = Logger.getLogger(AllInOne2.class.getName());
	 ...
	 */
	public AllInOne2(String log4jPropertiesPath) throws UnsupportedEncodingException{
		super();
